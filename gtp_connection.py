...
class GtpConnection:
    ...
    def gogui_rules_final_result_cmd(self, args):
        ...
        legal_moves = self.sorted_moves
        if len(legal_moves) == 0 and board_color == 1:
            self.respond("white")
        elif len(legal_moves) == 0 and board_color == 2:
            self.respond("black")
        else:
    ...
    def gogui_rules_legal_moves_cmd(self, args):
        ...
        for move in moves:
            ...
            legal_moves.append(format_point(coord))

        self.sorted_moves = " ".join(sorted(legal_moves))
        self.respond(self.sorted_moves)
    ...
    def play_cmd(self, args):
        ...
        try:
            ...
            if coord:
                ...
                return
            is_legal, move_type = self.board.play_move(move, color)
            if not is_legal and move_type == "Capture":
                self.respond("illegal move: \"{} {}\" capture".format(args[0], board_move))
                return
            elif not is_legal and move_type == "Suicide":
                self.respond("illegal move: \"{} {}\" suicide".format(args[0], board_move))
                return
            elif not is_legal and move_type == "Occupied":
                self.respond("illegal move: \"{} {}\" occupied".format(args[0], board_move))
                return
            else:
                self.debug_msg(
